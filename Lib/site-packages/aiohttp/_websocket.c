 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    ...
    __pyx_t_1 = PyBytes_GET_SIZE(__pyx_v_mask); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 20, __pyx_L1_error)
 ...
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_data); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 22, __pyx_L1_error)
 ...
 */
  __pyx_t_2 = PyByteArray_AsString(__pyx_v_data); if (unlikely(__pyx_t_2 == ((char *)NULL))) __PYX_ERR(0, 23, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_2 = PyBytes_AsString(__pyx_v_mask); if (unlikely(__pyx_t_2 == ((char *)NULL))) __PYX_ERR(0, 24, __pyx_L1_error)
